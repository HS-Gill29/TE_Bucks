...
public class JdbcTransferDaoTest extends BaseDaoTests {
    ...
    public void sendTransfer_status_successful(){
        ...
        Transfer sentTransfer = sut.sendTransfer(transferDto);
    ...
    public void requestTransfer_withNegativeAmount_should_throw_exception() {
        ...
        sut.requestTransfer(transferDto);
    }
    ...
    public void requestTransfer_status_successful(){
        ...
        Transfer transfer = sut.sendTransfer(transferDto);
